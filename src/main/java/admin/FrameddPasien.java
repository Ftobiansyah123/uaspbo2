 ...
 * @author Tobi
 */
public class FrameddPasien extends javax.swing.JFrame {

    /**
     * Creates new form FrameddPasien
     */
    public FrameddPasien() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameddPasien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameddPasien().setVisible(true);
            }
        });
    }
